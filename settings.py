...
load_dotenv()  # Loads .env file with site information
import os
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app1.context_processors.user_roles',
                'app1.context_processors.site_info',
            ],
        },
    },
]
...
if DEBUG:
    ...
    # Production email settings (for later)
    ...
    EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER')          # No default (fail explicitly)
    EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD')  # No default

SITE_DOMAIN = os.environ.get('SITE_DOMAIN', 'http://localhost:8000')  # Default for local dev
SITE_NAME = os.environ.get('SITE_NAME', 'My Site (Dev)')
...
# Email settings (keep your existing ones, these are just additions)
ACCOUNT_ACTIVATION_DAYS = 1  # Token validity period
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/'